                    ...
                    <div class="u-form u-form-1">
                      <form action="#" method="POST" class="u-clearfix u-form-horizontal u-form-spacing-10 u-inner-form"
                        ...
                        <div class="u-form-group u-form-name u-label-none u-form-group-1">
                          ...
                          <input type="text" placeholder="게임이름 검색" id="name-15e8" name="name"
                            class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-10 u-white u-input-1">
                        </div>
                        <div class="u-align-right u-form-group u-form-submit u-label-none u-form-group-2">
                          <input type="submit" value="submit" class="u-form-control-hidden">
                          <a href="#"
                            class="u-btn u-btn-round u-btn-submit u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-radius-11 u-btn-1">검색<br>
                          </a>
                        </div>
                      ...
                      <div class="u-container-layout u-container-layout-2">
                        ...
                        <div class="u-form u-form-2">
                          <form action="#" method="POST"
                            class="u-clearfix u-form-horizontal u-form-spacing-10 u-inner-form" source="custom"
                            ...
                            <div class="u-form-group u-form-select u-label-none u-form-group-3">
                              ...
                              <div class="u-form-select-wrapper">
                                <select id="select-6f55" name="select"
                                  class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-10 u-white u-input-2">
                            ...
                            <div class="u-align-right u-form-group u-form-submit u-label-none u-form-group-4">
                              <input type="submit" value="submit" class="u-form-control-hidden">
                              <a href="#"
                                class="u-btn u-btn-round u-btn-submit u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-radius-11 u-btn-2">검색<br>
                              </a>
                            </div>
                            <div class="u-form-send-message u-form-send-success"> Thank you! Your message has been sent.
                            </div>
                        ...
                        <c:forEach var="dto" items="${dtos}">
                          <a href="storeContent.do?gameId=${dto.gameId }">
                            <div class="u-align-center u-container-style u-grey-10 u-group u-group-2">
                              <div class="u-container-layout u-container-layout-3">
                                <img class="u-image u-image-round u-preserve-proportions u-radius-10 u-image-1"
                                  src="${pageContext.request.contextPath}/gameImg/${dto.img}" alt=""
                                  data-image-width="184" data-image-height="89">
