              ...
              <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-2">
                <div class="u-container-layout u-valign-top u-container-layout-2">
                  <div class="u-align-center u-form u-form-1">
                    <form action="#" method="POST" class="u-clearfix u-form-spacing-9 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 5px;">
                      <div class="u-form-email u-form-group">
                        <label for="email-62ef" class="u-label">아이디</label>
                        <input type="email" id="email-62ef" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-10 u-white" required="">
                      </div>
                      <div class="u-form-group u-form-group-2">
                        <label for="text-fb9c" class="u-label">비밀번호</label>
                        <input type="text" id="text-fb9c" name="text" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-10 u-white">
                      </div>
                      <div class="u-form-group u-form-group-3">
                        <label for="text-47ba" class="u-label">비밀번호 확인</label>
                        <input placeholder="" id="text-47ba" name="text-1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-10 u-white" type="text">
                      </div>
                      <div class="u-form-group u-form-group-4">
                        <label for="text-ceab" class="u-label">닉네임</label>
                        <input type="text" placeholder="" id="text-ceab" name="text-2" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-10 u-white">
                      </div>
                      <div class="u-form-group u-form-name">
                        <label for="name-62ef" class="u-label">이메일</label>
                        <input type="text" id="name-62ef" name="name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-10 u-white" required="">
                      </div>
                      <div class="u-form-date u-form-group u-form-group-6">
                        <label for="date-1bcc" class="u-label">생일</label>
                        <input type="date" placeholder="MM/DD/YYYY" id="date-1bcc" name="date" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-10 u-white" required="">
                      </div>
                      <div class="u-align-center u-form-group u-form-submit">
                        <a href="#" class="u-black u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-grey-60 u-radius-10 u-btn-1">가입하기</a>
