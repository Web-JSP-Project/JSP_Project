...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/buyToss.css" media="screen">
    ...
    <meta property="og:title" content="buyToss">
    <meta property="og:type" content="website">
  </head>
  <body class="u-body u-xl-mode"><%@ include file="../../layout/headeron.jsp" %>
    <section class="u-clearfix u-section-1" id="sec-7e5d">
                      ...
                      <div class="u-form u-form-1">
                        <form action="buy.p" method="POST"name="form" style="padding: 10px;">
                          ...
                          <div class="u-form-date u-form-group u-form-group-3">
                            ...
                            <input type="date" placeholder="" id="text-5dde" name="text" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                          </div>
                          <div class="u-align-right u-form-group u-form-submit">
                            <a href="#" class="u-black u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-grey-60 u-radius-10 u-btn-1">결제</a>
